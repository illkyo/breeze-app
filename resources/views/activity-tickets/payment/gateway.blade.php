<x-layout>
  ...
  <section class="antialiased flex justify-center">
    <div class="flex flex-col items-center bg-white p-8 rounded-xl w-full max-w-xl">
      <form action="/activity-tickets/{{ $activity->id }}/payment" method="POST" class="w-full max-w-xl rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        @csrf
        <div class="mb-6 grid grid-cols-2 gap-4">
          <div class="col-span-2 sm:col-span-1">
            <label for="full_name" class="mb-2 block text-sm text-gray-900 dark:text-white"> Full name (as displayed on card)* </label>
          ...
          <div class="col-span-2 sm:col-span-1">
            <label for="card-number-input" class="mb-2 block text-sm text-gray-900 dark:text-white"> Card number* </label>
          ...
          <div>
            <label for="card-expiration-input" class="mb-2 block text-sm text-gray-900 dark:text-white">Card expiration* </label>
            <div class="relative">
          ...
          <div>
            <label for="cvv-input" class="mb-2 flex items-center gap-1 text-sm text-gray-900 dark:text-white">
              ...
              <div id="cvv-desc" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700">
          ...
          <div class="flex flex-row gap-2">
            <a href="/activity-tickets/{{ $activity->id }}/payment/cancel" class="flex w-full items-center justify-center rounded-lg bg-indigo-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Cancel</a>
            <button type="submit" class="flex w-full items-center justify-center rounded-lg bg-indigo-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Pay now</button>
          </div>
      </form>
        ...
        <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
          <div class="space-y-2">
            <dl class="flex items-center justify-between gap-4">
              ...
              <dd class="text-base text-gray-900 dark:text-white">6000 MVR</dd>
            </dl>

            <dl class="flex items-center justify-between gap-4">
              <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Tax</dt>
              <dd class="text-base text-gray-900 dark:text-white">0</dd>
            </dl>
          </div>

          <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
            <dt class="text-base font-bold text-gray-900 dark:text-white">Total</dt>
            <dd class="text-base font-bold text-gray-900 dark:text-white">6000 MVR</dd>
          </dl>
        </div>
