<x-layout>
  ...
  <section class="antialiased flex justify-center">
    <div class="flex flex-col items-center bg-white p-8 rounded-xl w-full max-w-xl">
      <form action="/room-bookings/{{ $room->id }}/payment" method="POST" class="w-full max-w-xl rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        @csrf
        <div class="mb-6 grid grid-cols-2 gap-4">
          ...
          <div class="flex flex-row gap-2">
            <a href="/room-bookings/{{ $room->id }}/payment/cancel" class="flex w-full items-center justify-center rounded-lg bg-indigo-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Cancel</a>
